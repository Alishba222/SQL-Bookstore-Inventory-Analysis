...
* **Null Handling:** Using COALESCE() to ensure accurate calculations.

## How to Use
1. Download the `OnlineBookstore.sql` file.
2. Create a new database in PostgreSQL/pgAdmin.
3. Run the provided SQL script to create tables and insert data.
4. Update the file path in the COPY command to match the location of your local CSV files.
